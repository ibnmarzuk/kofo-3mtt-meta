...
//#region node_modules/.nitro/vite/services/ssr/assets/router-6q_a06u6.js
...
var styles_default = "/assets/styles-Cxi6ddG_.css";
var APP_NAME = "Kofa";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Kofa is a bounded first-line WhatsApp assistant for Nigerian service shops. It answers the FAQ. A human still closes the door."
			},
			{
				name: "theme-color",
				content: "#3E4A38"
...
var $$splitComponentImporter$2 = () => import("./routes-CgGYfO1Y.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./desk-BVxgLweB.mjs");
var TABS = [
	"inbox",
	"faqs",
	"guard",
...
var Route$1 = createFileRoute("/desk")({
	validateSearch: (s) => ({ tab: TABS.includes(s.tab) ? s.tab : "inbox" }),
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./line-Cb5kV5y0.mjs");
var Route = createFileRoute("/line")({
