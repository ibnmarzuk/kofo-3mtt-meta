...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-11jHJkF2.mjs");
...
var manifest = { "6ccbf21a744e8496945950581d31836cee69c2976e3c45b40893f81437edd7d6": {
	functionName: "sendLine_createServerFn_handler",
	importer: () => import("./reply-Df4c1nx6.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-6q_a06u6.mjs").then((n) => n.t),
